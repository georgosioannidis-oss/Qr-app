@echo off
REM QR Menu print agent — Grill station — Wok & Walk
...
REM ---------- Pre-filled for Wok & Walk — Grill ----------
set "PRINT_AGENT_BASE_URL=https://scannorder.ink"
set "PRINT_AGENT_RESTAURANT_SLUG=wok-walk"
set "PRINT_AGENT_STATION=grill"
...
echo.
echo Starting print agent for Grill... (close this window to stop)
echo.
